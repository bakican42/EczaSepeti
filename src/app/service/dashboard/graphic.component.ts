...
//   public ctx2: HTMLElement | ChartItem | null = null
  ...
  ngOnInit() {
    // order count
    // this.getOrderCount.fetch({ "where": { "service_id": { "_eq": this.authService.companyId } } }, { fetchPolicy: 'no-cache' }).subscribe(result => {
...
//       "where": {
//         "service_id": { "_eq": this.authService.companyId },
